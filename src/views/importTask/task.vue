  ...
  <div class="Import">
    ...
    <div class="conter">
      <div style="padding:10px 0;">
        <p style="float:left;border-left: 5px solid #1ab394;padding-left: 10px;color: #1ab394;">导入导出管理列表</p>
        <el-button type="text" icon="el-icon-plus" style="float:right;color: #1ab394;" @click="addisanswer=true">新建任务</el-button>
      </div>
    ...
    <el-dialog width="35%" :visible.sync="addisanswer" append-to-body title="数据源详情">
      <el-form ref="form" :model="form" label-width="100px" class="dialog">
        ...
        <el-form-item label="端口号">
          <el-input v-model="form.name" placeholder="请输入端口号" />
        </el-form-item>
    ...
    <el-dialog width="35%" :visible.sync="isanswer" append-to-body title="查看任务">
      <el-form ref="form" :model="form" label-width="100px" class="dialog">
        ...
        <el-form-item>
          <el-row>
            <el-col :span="16">  <el-button class="stop" type="danger" size="mini">暂停</el-button></el-col>
            <!-- <el-col :span="8">  <el-button type="primary" size="mini">继续</el-button></el-col> -->

            <el-col :span="8">  <el-button type="primary" size="mini" @click="isanswer=false">结束</el-button></el-col>
          </el-row>
...
export default {
  ...
  methods: {
    // stop() {
    //   this.PauseContinue = this.PauseContinue
    // },
    // 获取角色
    roleList() {
      roleList().then(res => {
